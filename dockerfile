...
#COPY model_saved/base_real_data/base_bert/* /model_saved/base_real_data/base_bert/

#RUN mkdir -p model_saved/base_try_data

RUN mkdir -p model_saved/base_real_data/roberta_wwm_large
COPY model_saved/base_real_data/roberta_wwm_large/* /model_saved/base_real_data/roberta_wwm_large/
