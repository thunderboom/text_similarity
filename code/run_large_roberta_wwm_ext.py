...
class RobertaLargeConfig:
    ...
    def __init__(self):
        # 预训练模型路径
        self.pretrain_path = '../data/External/pretrain_models/chinese_roberta_wwm_large_ext_pytorch'
        ...
        self.data_augment_method = ['train_dev_augment', 'chip2019']
        # 计算loss的方法
